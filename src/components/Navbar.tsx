...
export default function Navbar() {
  ...
  return (
    <div
      className="w-full max-w-[1920px] z-50 fixed"
      style={{ fontFamily: "'Outfit', sans-serif", height: "74px" }}
    >
      {/* Desktop Navbar */}
      <div
      ...
      >
        ...
        {/* Content layer */}
        <div className="relative z-10 flex items-center justify-between h-full px-10 max-[1500px]:px-4">
          {/* Logo */}
          ...
          {/* Nav Links */}
          <nav className="pl-6.5 flex items-center gap-6 max-[1500px]:gap-3">
            {[
              { label: "Home", to: "/" },
      ...
      {/* Mobile Navbar */}
      <div className="relative w-full xl:hidden h-[58px]">
        <img
          src={MobileNotch}
          alt="mobile notch"
          className="absolute w-full h-[58px] md:hidden object-cover"
        />
        <svg
          viewBox="0 0 768 57"
          preserveAspectRatio="none"
          className="absolute inset-0 w-full h-[58px] hidden md:block object-cover"
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0)">
            <foreignObject x="-36" y="-80" width="840" height="173">
              <div
            ...
            <path
              d="M0 49.5V-44H768V49C768 55.4 762.476 57 759.714 57H666C660.4 57 658 53.6667 657.5 52C655.667 46.8333 651.4 34.9 649 28.5C646.6 22.1 640.333 20.1667 637.5 20H126C119.2 20 115.833 25 115 27.5C113.333 32.1667 109.5 43 107.5 49C105.5 55 97.7997 56.8333 94.1996 57H8C2.4 57 0.333333 52 0 49.5Z"
              fill="black"
              fillOpacity="0.6"
            />
          </g>
          ...
          <defs>
            <clipPath id="bgblur_clip" transform="translate(36 80)">
              <path d="M0 49.5V-44H768V49C768 55.4 762.476 57 759.714 57H666C660.4 57 658 53.6667 657.5 52C655.667 46.8333 651.4 34.9 649 28.5C646.6 22.1 640.333 20.1667 637.5 20H126C119.2 20 115.833 25 115 27.5C113.333 32.1667 109.5 43 107.5 49C105.5 55 97.7997 56.8333 94.1996 57H8C2.4 57 0.333333 52 0 49.5Z" />
            </clipPath>

            <clipPath id="clip0">
              <rect width="768" height="57" />
            </clipPath>
          </defs>
        </svg>
        ...
        <div className="absolute inset-0 flex items-center justify-between px-4 z-10">
          <img src={LogoM} alt="logo" className="w-[68px] object-contain" />
          <button
              ...
              {[
                {
                  ...
                  icon: (
                    <Home
                      className={`w-[18px] h-[18px] ${"/" === window.location.pathname ? "text-white" : "text-[#929292]"}`}
                    />
                  ),
                },
                {
                  ...
                  icon: (
                    <Settings
                      className={`w-[18px] h-[18px] ${"/services" === window.location.pathname ? "text-white" : "text-[#929292]"}`}
                    />
                  ),
                },
                {
                  ...
                  icon: (
                    <BriefcaseBusiness
                      className={`w-[18px] h-[18px] ${"/opportunities" === window.location.pathname ? "text-white" : "text-[#929292]"}`}
                    />
                  ),
                },
                {
                  ...
                  icon: (
                    <Users
                      className={`w-[18px] h-[18px] ${"/customers" === window.location.pathname ? "text-white" : "text-[#929292]"}`}
                    />
                  ),
                },
                {
                  ...
                  icon: (
                    <User
                      className={`w-[18px] h-[18px] ${"/about" === window.location.pathname ? "text-white" : "text-[#929292]"}`}
                    />
                  ),
                },
                {
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <ChevronRight
                      className={`w-[18px] h-[18px] ${to === window.location.pathname ? "text-white" : "text-[#929292]"}`}
                    />
                  </div>
                </Link>
              ))}
