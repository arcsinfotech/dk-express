                  ...
                  <div className="w-[271px] h-[230px] bg-[#E64949] mb-3 rounded-[26px] p-[22px] pr-3 flex flex-col gap-2 relative">
                    <div className="absolute top-12 right-6">
                      <svg width="175" height="179" viewBox="0 0 175 179" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0.5 0.5C22 5.66667 61 23 108.5 6.5C150.56 -8.1103 174.5 38 161 58.5C137.951 93.5 63.5 119 92.5 164C105.594 184.318 145 180.5 174.5 161" stroke="#F87E7E" stroke-linecap="round" stroke-dasharray="6 6"/>
                      </svg>
                    </div>
