      ...
      <div className="container mx-auto px-4">
        <div className="grid max-[768px]:grid-cols-1 grid-cols-2 gap-16 max-[768px]:gap-[40px] items-center">
          ...
          <motion.div
            ...
            className="relative max-[768px]:order-2"
          >
            <div className="w-[566px] max-[768px]:w-full max-[768px]:h-fit relative max-[768px]:pl-4.5">
              ...
              <div className="absolute bottom-48 -right-20 max-[768px]:-right-3 z-10 flex flex-col gap-[28px]">
                <div className="text-white bg-[#E6494966] backdrop-blur-[90px] rounded-[16px] w-[162px] h-[99px] max-[768px]:w-[118px] max-[768px]:h-[72px] px-3 flex flex-col gap-1.5 items-center justify-center shadow-[0_12px_60px_0_rgba(230,73,73,0.4)]">
                  <p className="text-[32px] max-[768px]:text-[24px] text-white">27+</p>
                  <div className="min-h-px w-full bg-[#FFFFFF4A]" />
                  <p className="text-sm max-[768px]:text-[10px] font-medium">Years of Service</p>
                </div>
              </div>

              <div className="flex items-center mb-3 max-[768px]:mb-2 gap-3 max-[768px]:gap-2 max-[768px]:w-full">
                ...
                <div className="relative max-[768px]:w-full">
                  ...
                  <div className="absolute z-10 -left-1 top-60 -translate-x-1/2 -translate-y-1/2 bg-[#00112D] w-[108px] h-[108px] max-[768px]:w-[68px] max-[768px]:h-[68px] rounded-full flex items-center justify-center max-[768px]:top-38">
                    <div className="w-[84px] h-[84px] max-[768px]:w-[54px] max-[768px]:h-[54px] bg-[#E6494933] rounded-full flex items-center justify-center backdrop-blur-[90px]">
                      <svg width={isMobile ? "20" : "32"} height={isMobile ? "20" : "32"} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="w-[271px] max-[768px]:w-full h-[230px] max-[768px]:h-[146px] bg-[#E64949] mb-3 max-[768px]:mb-2 rounded-[26px] max-[768px]:rounded-[16px] p-[22px] max-[768px]:p-[12px] pr-3 flex flex-col gap-2 relative overflow-hidden">
                    
                    <div className="absolute top-12 right-6 max-[768px]:top-6 max-[768px]:right-1">
                    ...
                    <div className="text-white font-semibold text-[18px] max-[768px]:text-[12px] pr-3 max-[768px]:pr-10">
                  ...
                  <div className="relative w-[271px] max-[768px]:w-full h-[125px] max-[768px]:h-[80px] bg-[#E64949] rounded-[26px] max-[768px]:rounded-[16px] overflow-hidden">
                    <div className="absolute top-1 right-0">
                      <svg width={isMobile ? "162" : "176"} height={isMobile ? "32" : "51"} viewBox="0 0 176 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.6">
                ...
                <div className="w-[284px] h-[367px] max-[768px]:h-[233px]">
                  <img src={peopleImg} alt="" className="rounded-[26px] max-[768px]:rounded-[10px] shadow-xl h-full w-auto object-cover" />
                </div>
              </div>
          ...
          >
            <div className="flex flex-col gap-0 mb-[26px] max-[768px]:mb-[16px]">
              <div className="bg-[#FFFFFF14] text-white w-fit px-3 py-1.5 rounded-[16px] font-normal text-[18px] mb-3 max-[768px]:mb-4">
                Who We Are
              </div>
              <div className="text-[54px] max-[768px]:pr-10 max-[768px]:text-[32px] font-semibold text-white leading-none max-[768px]:leading-[38px]">
                Trusted Transportation
              </div>
              <div className="text-[54px] max-[768px]:text-[32px] font-semibold text-white leading-none max-[768px]:leading-[38px]">Partner <span className="text-[#E64949]">Since 1997</span></div>
            </div>
            <p className="text-white text-[16px] max-[768px]:text-[14px] leading-relaxed mb-8 max-[768px]:mb-[26px]">
            ...
            <ul className="space-y-3">
              {highlights.map((item) => (
                <li key={item} className="flex items-center gap-3 max-[768px]:gap-2">
                  <CheckCircle className="w-5 h-5 text-[#00C023] shrink-0" />
                  <span className="text-[16px] max-[768px]:text-[14px] font-medium text-[#FFFFFF]">{item}</span>
                </li>
              ))}
            </ul>
          </motion.div>
