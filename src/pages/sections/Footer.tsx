...
export default function Footer() {
  ...
  return (
    <footer
      className="w-full bg-[#00112D] text-white"
      ...
      <div className="mx-[135px]">
        <div className="flex items-start justify-between gap-[130px] mb-[37px] pt-[123px]">
          ...
          <div className="flex flex-col gap-3.5">
            ...
            <div className="flex items-center h-[48px] overflow-hidden">
              ...
              >
                ...
                >
                  ...
                  />
                  <path
                    d="M13.6992 18.3456L19.7492 12.3061L13.6992 6.26562"
                    stroke="white"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            {/* Social Buttons */}
            <div
              className="flex flex-wrap gap-4 mt-[23px] self-end"
