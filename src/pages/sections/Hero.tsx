  ...
  return (
    <div className="w-full h-full relative overflow-hidden bg-[#00112D]">
        ...
        <div className="w-full h-full flex flex-col items-center justify-center">
            <div className="w-full h-full flex max-[768px]:flex-col max-[768px]:gap-[26px] items-center justify-center px-[135px] max-[768px]:px-[20px]">
                <div className=" w-1/2 max-[768px]:w-full h-full max-[768px]:h-fit z-1 flex flex-col items-start max-[768px]:items-center justify-center gap-3">
                    ...
                    <div className="mt-6 flex items-center h-[42px] gap-2 max-[768px]:gap-4">
                        <button className="h-full border border-white rounded-full px-4 text-white text-[16px] max-[768px]:text-[14px] font-medium cursor-pointer outline-none" style={{ fontFamily: "'Outfit', sans-serif" }}>
                        Get Instant Quote
                        </button>
                        <button className="h-full border border-[#E64949] bg-[#E64949] hover:bg-transparent hover:text-[#E64949] rounded-full px-4 text-white text-[16px] max-[768px]:text-[14px] font-medium cursor-pointer transition-all duration-200 outline-none" style={{ fontFamily: "'Outfit', sans-serif" }}>
                        Track Shipment
                        </button>
                    </div>
                </div>
            ...
            <div className="z-1 w-full min-h-[68px] flex max-[768px]:flex-col items-center bg-[#F6F6F6]">
                <div className="pl-[135px] max-[768px]:p-3 text-[24px] max-[768px]:text-[14px] font-normal" style={{ fontFamily: "'Outfit', sans-serif" }}>
