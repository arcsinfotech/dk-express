  ...
  return (
    <div className="p-[26px] max-[768px]:p-[16px] rounded-[26px] bg-white relative overflow-hidden">
      ...
      <div className="flex justify-between items-center">
        <div>
          <div className="w-[58px] h-[58px] max-[768px]:w-[48px] max-[768px]:h-[48px] bg-[#E64949] rounded-full flex items-center justify-center mb-4 max-[768px]:mb-2">
            {icon}
          </div>

          <div
            className="text-[24px] max-[768px]:text-[18px] font-semibold capitalize mb-[14px]"
      ...
      <div className="grid grid-cols-2 max-[768px]:grid-cols-1 gap-x-10 gap-y-4 max-[768px]:gap-y-2">
...
const Services = () => {
  ...
  const services = [
    {
      icon: (
        <img src={CoolVan} alt="Refrigerated Transport" width={ isMobile ? "24" : "32"} height={ isMobile ? "24" : "32"} />
      ),
    ...
    {
      icon: <img src={DryVan} alt="Dry Van" width={ isMobile ? "24" : "32"} height={ isMobile ? "24" : "32"} />,
      title: "Dry Van",
      details: [
    ...
    {
      icon: (
        <img src={FastVan} alt="Storage & Re-Delivery" width={ isMobile ? "24" : "32"} height={ isMobile ? "24" : "32"} />
      ),
    ...
    {
      icon: <img src={Team} alt="Team Driving" width={ isMobile ? "24" : "32"} height={ isMobile ? "24" : "32"} />,
      title: "Team Driving",
      details: [
    ...
    {
      icon: <img src={CrossDock} alt="Cross Dock" width={ isMobile ? "24" : "32"} height={ isMobile ? "24" : "32"} />,
      title: "Cross Dock",
      details: [
  ...
  return (
    <div className="min-h-screen">
      {/* services */}
      <div className="w-full h-full flex max-[768px]:flex-col items-start gap-4 px-[135px] max-[768px]:px-[20px]">
        <div className="sticky top-[10%] max-[768px]:static">
          <div
            className="relative overflow-hidden min-w-[678px] max-[768px]:min-w-full h-[536px] max-[768px]:h-[328px] rounded-[26px] px-[25px] py-[30px] my-[120px] max-[768px]:my-0 max-[768px]:mt-[76px]"
            style={{
              background:
          ...
          >
            ...
            <div
              className="font-semibold text-[54px] max-[768px]:text-[32px] leading-[58px] max-[768px]:leading-[38px] text-white mb-[16px]"
              style={{ fontFamily: "Raleway" }}
            >
              Reliable Freight & Logistics Services
            </div>
            <div
              className="text-[16px] max-[768px]:text-[14px] max-[768px]:leading-[20px] capitalize text-white font-normal"
              style={{ fontFamily: "Figtree" }}
            >
        ...
        <div className="no-scrollbar flex flex-col gap-4 h-full w-full py-[120px] max-[768px]:py-0">
