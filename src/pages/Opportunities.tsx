...
const Opportunities = () => {
  ...
  const cards = [
    {
      icon: <img src={ModernFleet} alt="Modern Fleet" width={ isMobile ? "24" : "32"} height={ isMobile ? "24" : "32"} />,
      title: "Modern Fleet",
    ...
    {
      icon: (
        <img src={OwnerOperator} alt="Owner-Operator" width={ isMobile ? "24" : "32"} height={ isMobile ? "24" : "32"} />
      ),
    ...
    {
      icon: (
        <img src={Growth} alt="Growth Opportunities" width={ isMobile ? "24" : "32"} height={ isMobile ? "24" : "32"} />
      ),
  ...
  function getCard({
    ...
    return (
      <div key={title} className="flex flex-col p-[26px] max-[768px]:p-[16px] gap-4 max-[768px]:gap-3 rounded-[26px] relative overflow-hidden">
        ...
        <div className="flex flex-col gap-4 max-[768px]:gap-3">
          <div className="w-[58px] h-[58px] max-[768px]:w-[48px] max-[768px]:h-[48px] bg-[#E64949] rounded-full flex items-center justify-center">
            {icon}
          </div>
          <div
            className="text-[24px] max-[768px]:text-[20px] text-[#262626] font-semibold capitalize"
  ...
  function getReason({
    ...
    return (
      <div
        key={title}
        className="flex w-[310px] max-[768px]:w-full bg-[#FFFFFF1A] rounded-[16px] h-fit items-center gap-4 p-3 max-[768px]:gap-3"
      >
        <div className="w-[75px] h-[75px] max-[768px]:w-[48px] max-[768px]:h-[48px] rounded-[12px] bg-[#FFFFFF1A] flex items-center justify-center">
          {icon}
        </div>
        <div
          className="text-[18px] max-[768px]:text-[14px] leading-[22px] max-[768px]:leading-[16px] font-normal capitalize text-white"
          style={{ fontFamily: "'Figtree', sans-serif" }}
        >
          {title}
        </div>
  ...
  return (
    <div className="min-h-screen">
      <div className="px-[135px] py-[120px] max-[768px]:px-[20px] max-[768px]:py-[60px]">
        <div className="flex flex-col items-center justify-center gap-[26px] w-full">
          <div
            className="text-[54px] max-[768px]:text-[32px] max-[768px]:text-center max-[768px]:px-6 max-[768px]:leading-[38px] text-[#262626] font-semibold"
            style={{ fontFamily: "'Raleway', sans-serif" }}
          >
            Your Success <span className="text-[#E64949]">Starts Here</span>
          </div>
          <div
            className="text-[18px] max-[768px]:text-[14px] text-[#545454] text-center px-100 max-[768px]:px-0 max-[768px]:leading-[20px] capitalize font-normal"
            style={{ fontFamily: "'Figtree', sans-serif" }}
          >
          ...
          <div className="mt-[34px] max-[768px]:mt-[26px] flex max-[768px]:flex-col gap-4 max-[768px]:gap-3 items-center justify-center">
            {cards.map((card) => getCard(card))}
          </div>
        </div>
      </div>

      <div className="bg-[#02112E] px-[135px] py-[120px] max-[768px]:px-[20px] max-[768px]:py-[60px] flex max-[768px]:flex-col max-[768px]:gap-[26px] items-center justify-between">
        <div className="max-w-[496px] max-[768px]:max-w-full">
          <div
            className="text-[54px] max-[768px]:text-[32px] leading-[64px] max-[768px]:leading-[38px] text-[#FFFFFF] font-semibold max-[768px]:text-center"
            style={{ fontFamily: "'Raleway', sans-serif" }}
          >
            Why Choose <br />
          ...
          <div
            className="mt-3 text-[18px] max-[768px]:text-[14px] max-[768px]:leading-[20px] text-white font-normal capitalize max-[768px]:text-center"
            style={{ fontFamily: "'Figtree', sans-serif" }}
          >
        ...
        <div className="grid grid-cols-3 max-[768px]:grid-cols-1 gap-4 max-[768px]:gap-2 max-[768px]:w-full">
